defmodule BotArmyCodingAgentProxy.Skills.Example do
  @moduledoc """
  Example skill for Coding Agent Proxy Bot.
  ...
  1. NATS message arrives on trigger subject: `bot.bot_army_coding_agent_proxy.command.example`
  ...
  5. Result published to response subject: `bot.bot_army_coding_agent_proxy.response.<request_id>`
  ...
  1. Rename: `lib/bot_army_coding_agent_proxy/skills/your_skill.ex`
  ...
  def nats_triggers do
    ...
    [
      "bot.bot_army_coding_agent_proxy.command.example"
    ]
  end
